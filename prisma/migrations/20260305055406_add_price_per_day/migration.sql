...
INSERT INTO "new_Contract" ("checkIn", "checkOut", "createdAt", "id", "number", "priceRub", "propertyCode", "seq", "tenantAddress", "tenantId", "tenantName", "tenantPassport", "type", "updatedAt", "year") SELECT "checkIn", "checkOut", "createdAt", "id", "number", "priceRub", "propertyCode", "seq", "tenantAddress", "tenantId", "tenantName", "tenantPassport", "type", "updatedAt", "year" FROM "Contract";
DROP TABLE "Contract";
